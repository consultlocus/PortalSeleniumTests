...
namespace ConsultlocusSelenium.Tests.CompanyUser.Design
{
    public class ApplicationsTests
    {
        ...
        [Order(1)]
        [Test]
        public void CanCompanyUserViewApplicationsTab()
        {
            _avatarButton.Click();
            ...
            {
                Assert.Fail("Company user has access to the applications tab!");
            }
        }
    }
}